      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <Link href="/" style={{
            ...
            gap: '10px', textDecoration: 'none', marginBottom: '20px'
          }}>
            <div style={{
        ...
        <div style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '8px', touchAction: 'manipulation',
                  zIndex: 2
                }}
              >
          ...
          <Link href="/register" style={{
            ...
            background: '#1a2740', border: '1px solid #243b55',
